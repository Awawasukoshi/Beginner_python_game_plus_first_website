...
def initial_conditions():
    global still_alive, enemy_hp, enemy_name, boss_fight, end_scaling, pokeballs, is_npc_battle, Roy
...
def scientist_save():
    ...
    input()
    print('"Follow me to my lab i will heal your pokemon up as a thanks. My name is Professor Elm. Whats your name friend?"')
    input()
    print(char_name)
    input()
    print(f"You head back to the lab and Professor Elm heals your {pokemon_choose} back to full health")
    input()
    ...
    input()
    print("After that talk with Professor Elm, you are incredibly excited to set off on your new adventure, but")
    input()
